...
public class ModificarServicioSalud {

	@Cuando("^modifique la información del servicio de salud$")
	public void modifique_la_información_del_servicio_de_salud() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonEditar("Servicio");
		// ---------------------------------------------------------------------
		// CONFIGURAR SERVICIO
		// ---------------------------------------------------------------------
	...
	@Cuando("^ingrese solo el monto limite y deje vacío el resto de campos al modificar la configuración del servicio$")
	public void ingrese_solo_el_monto_limite_y_deje_vacío_el_resto_de_campos_al_modificar_la_configuración_del_servicio()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	@Cuando("^deje vacío el rango máximo despues de seleccionar un año en la unidad de tiempo al modificar la configuración del servicio$")
	public void deje_vacío_el_rango_máximo_despues_de_seleccionar_un_año_en_la_unidad_de_tiempo_al_modificar_la_configuración_del_servicio()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	@Cuando("^ingrese un monto limite superior al modificar la configuración del servicio$")
	public void ingrese_un_monto_limite_superior_al_modificar_la_configuración_del_servicio() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonEditar("Servicio");
	...
	@Cuando("^ingrese una unidad de tiempo limite superior al modificar la configuración del servicio$")
	public void ingrese_una_unidad_de_tiempo_limite_superior_al_modificar_la_configuración_del_servicio()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
