...
public class AdicionarTipoDeCoberturaSalud {
	...
	public void deje_vacio_los_campos_obligatorios_en_la_configuración_del_tipo_de_cobertura() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Tipo de cobertura");
	...
	public void ingrese_solo_el_monto_limite_y_deje_vacío_el_resto_de_campos_en_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void deje_vacío_el_rango_máximo_despues_de_seleccionar_un_año_en_la_unidad_de_tiempo_para_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void ingrese_un_monto_limite_superior_en_la_configuración_del_tipo_de_cobertura() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Tipo de cobertura");
	...
	public void adicione_varios_tipos_de_cobertura_con_un_monto_limite_superior_al_configurado_en_la_categoría()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void ingrese_una_unidad_de_tiempo_limite_superior_en_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
