...
public class AdicionarServicioSalud {

	@Dado("^he adicionado un grupo de cobertura a la categoría$")
	public void he_adicionado_un_grupo_de_cobertura_a_la_categoría() throws Throwable {
		// ---------------------------------------------------------------------
	...
	public void adicione_un_servicio_al_cuadro_de_beneficios() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	@Cuando("^deje vacio los campos obligatorios en la configuración del servicio$")
	public void deje_vacio_los_campos_obligatorios_en_la_configuración_del_servicio() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Servicio");
	...
	@Cuando("^ingrese solo el monto limite y deje vacío el resto de campos en la configuración del servicio$")
	public void ingrese_solo_el_monto_limite_y_deje_vacío_el_resto_de_campos_en_la_configuración_del_servicio()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	@Cuando("^deje vacío el rango máximo despues de seleccionar un año en la unidad de tiempo para la configuración del servicio$")
	public void deje_vacío_el_rango_máximo_despues_de_seleccionar_un_año_en_la_unidad_de_tiempo_para_la_configuración_del_servicio()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	@Cuando("^ingrese un monto limite superior en la configuración del servicio$")
	public void ingrese_un_monto_limite_superior_en_la_configuración_del_servicio() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Servicio");
	...
	@Cuando("^adicione varios servicios con un monto limite superior al configurado en la categoría$")
	public void adicione_varios_servicios_con_un_monto_limite_superior_al_configurado_en_la_categoría()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		...
		// CONFIGURAR SERVICIO
		// ---------------------------------------------------------------------
		Beneficios.seleccionarNombreDelBeneficio("EMERGENCIA", "Servicio");
		// ---------------------------------------------------------------------
		// Monto Beneficio
		// ---------------------------------------------------------------------
	...
	@Cuando("^ingrese una unidad de tiempo limite superior en la configuración del servicio$")
	public void ingrese_una_unidad_de_tiempo_limite_superior_en_la_configuración_del_servicio() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Servicio");
	...
	public void adicione_un_servicio_al_cuadro_de_beneficios_que_ya_haya_sido_adicionado() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonAñadir("Servicio");
