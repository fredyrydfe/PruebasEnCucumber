...
public class ModificarTipoDeCoberturaSalud {

	@Cuando("^modifique la información tipo de cobertura de salud$")
	public void modifique_la_información_tipo_de_cobertura_de_salud() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonEditar("Tipo de cobertura");
		// ---------------------------------------------------------------------
	...
	public void ingrese_solo_el_monto_limite_y_deje_vacío_el_resto_de_campos_al_modificar_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void deje_vacío_el_rango_máximo_despues_de_seleccionar_un_año_en_la_unidad_de_tiempo_al_modificar_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void ingrese_un_monto_limite_superior_al_modificar_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void ingrese_una_unidad_de_tiempo_limite_superior_al_modificar_la_configuración_del_tipo_de_cobertura()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
