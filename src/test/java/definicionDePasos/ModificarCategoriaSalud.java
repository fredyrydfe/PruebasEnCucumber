...
public class ModificarCategoriaSalud {
	...
	public void modifique_la_información_de_la_categoría_de_salud() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonEditar("Categoría");
		// ---------------------------------------------------------------------
	...
	public void ingrese_solo_el_monto_limite_y_deje_vacío_el_resto_de_campos_al_modificar_la_configuración_de_la_categoría()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void deje_vacío_el_rango_máximo_despues_de_seleccionar_un_año_en_la_unidad_de_tiempo_al_modificar_la_configuración_de_la_categoría()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
	...
	public void ingrese_un_monto_limite_superior_al_modificar_la_configuración_de_la_categoría() throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
		Beneficios.presionarBotonEditar("Categoría");
	...
	public void ingrese_una_unidad_de_tiempo_limite_superior_al_modificar_la_configuración_de_la_categoría()
			throws Throwable {
		// ---------------------------------------------------------------------
		// CONFIGURAR BENEFICIOS
		// ---------------------------------------------------------------------
