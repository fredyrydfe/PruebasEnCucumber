# language: es
# encoding: iso-8859-1
## ININTER-54 Modificar información de los servicios de la propuesta
Característica: Modificar información de los servicios en la propuesta de Salud
  Como Gerente quiero modificar la información ingresada a un Servicio dentro de la propuesta para 
  ser presentada al área de Negocios.

  @SmokeTest @Regresión
  Escenario: el usuario de producto modifica la información de un servicio
