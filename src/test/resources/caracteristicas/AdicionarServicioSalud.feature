...
Característica: Adicionar servicio al cuadro de beneficios de Salud
  Como Usuario del Área de Productos quiero ingresar la configuración para un Servicio activo
  ...
  @Regresión
  Escenario: el usuario adiciona un servicio con un monto limite superior al configurado en la categoría
    Dado que he creado una nueva conceptualización de propuesta
    Y he adicionado una categoría al cuadro de beneficios
    Y he adicionado un grupo de cobertura a la categoría
	...
	@Regresión
  Escenario: el usuario adiciona varios servicios donde la suma del monto limite supera al configurado en la categoría
    Dado que he creado una nueva conceptualización de propuesta
    Y he adicionado una categoría al cuadro de beneficios
    Y he adicionado un grupo de cobertura a la categoría
